...
def main():
    ...
    ############## 
    parser.add_argument("--dataset", default=None, type=str, required=True, help="data file that has text prompts")
    parser.add_argument("--output", default=None, type=str, required=True, help="output data file")
    ###############################
    ...
    with torch.no_grad():
        for data_item in input_data:
            ...
            if cnt%100==0:
                logging.info("{}/{}".format(cnt, len(input_data)))
            cnt+=1
